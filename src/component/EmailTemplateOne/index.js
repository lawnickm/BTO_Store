                    ...
                    <tbody>
                        <tr>
                            <td>
                                ...
                                <table className="main-bg-light" border="0" cellpadding="0" cellspacing="0" width="100%"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style={{ marginTop: "30px" }}>
                                    <tbody>
                                ...
                                <table className="main-bg-light text-center" align="center" border="0" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style={{ padding: "30px" }}>
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" className="footer-social-icon text-center"
